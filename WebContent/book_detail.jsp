...
<%
	if (request.getAttribute("toBookDetail") == null) {
...
<html>
	...
	<body>
		...
		<form action="CartServlet" method="post">
			...
			<input type="hidden" name="target_servlet" value="<%= "BookDetailServlet?id=" + book.getIsbn() %>">
			<input type="submit" value="カートに入れる">
		</form>
		<button onclick="location.href='SearchServlet'">戻る</button>
	</body>
</html>